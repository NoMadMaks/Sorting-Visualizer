...
class DrawInformation:
    ...
    def __init__(self, width, height, lst):
        ...
        pygame.display.set_caption("Sorting Algorithm Visualizor")
        self.set_list(lst)
...
def draw(draw_info, algo_name, ascending):
    ...
    tittle = draw_info.FONT.render(f"{algo_name} - {'Ascending' if ascending else 'Descending'}", 1, draw_info.GREEN)
    draw_info.window.blit(tittle, (draw_info.width/2 - tittle.get_width()/2, 5))
...
def main():
    ...
    draw_info = DrawInformation(1024, 768, lst)
    sorting = False
    ascending = True
